...
import { AdminAccountComponent } from 'app/entities/admin-account/admin-account.component';
...
describe('Component Tests', () => {
  describe('AdminAccount Management Component', () => {
    let comp: AdminAccountComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AdminAccountComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.adminAccounts && comp.adminAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
